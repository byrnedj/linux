 ...
 *  cache (cache-allocating) rather than bypassing it. Advisory: drivers that
 *  cannot honour it ignore the flag.
 */
enum dma_ctrl_flags {
...
static inline int dmaengine_chan_set_attr(struct dma_chan *chan,
		enum dma_chan_attr attr, void *data)
{
